...
def make_exp_params(study_name: str) -> List[ExpParam]:
    ...
    if study_name == 'none':
        ...
        params = [make_param(clscale, dt) for clscale in clscales for dt in dts]
        ...
        params = [make_param(*args) for args in itls.product(EMODS, VCOVERS, MCOVERS)]
        ...
        params = [
            ...
            for args in itls.product(
                zip(clscales, nzs), EMODS, vcovs, mcovs, psubs, damage_measures
            )
        ]
